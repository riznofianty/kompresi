                        ...
                        <div class="col-lg-12">
                            <div class="main-card mb-3 card">
                                <div class="card-header mt-2 mb-2 text-center">
                                    <h3>Upload File FLE</h3>
                                </div>
                                <div class="card-body">
                                    <div class="position-relative row form-group">
                                        <div class="col-sm-12">
                                            <div class="fileUpload btn btn-info text-center button3">
                                                <span>Pilih File .FLE</span>
                                                <input name="file" id="file" type="file" class="form-control-file upload text-center" accept=".FLE" required>
                                            </div>
