...
if (isset($_POST['compress'])) {
	...
	$compress = new Compress('file/'.$file);	//membuat objek baru dari kelas Compress dengan file yang akan diolah
	$compress->EvenRodehCode();			//menjalankan fungsi EvenRodehCode
                        ...
                        <div class="col-lg-12">
                            <div class="main-card mb-3 card">
                                ...
                                <div class="card-body"><h5><?php echo "Ukuran File TXT Anda berkurang dari ".$compress->getBitBefore()." bytes menjadi ".$compress->getBitAfter()." bytes";?></h5>
                                  ...
                                  <textarea style="width: 100%;" ><?php echo $compress->EvenRodehCode();?></textarea>
                                  </div>
                                <div class="card-body">
